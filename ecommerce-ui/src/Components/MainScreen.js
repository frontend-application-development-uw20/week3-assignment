...
class Main_screen extends React.Component {
    ...
    addAirbnbs= (e) =>{
        ...
        // let isSuperhost = formElem.isSuperhost.value;
            ...
            <div className= "new-airbnb-form">
                <form onSubmit={this.addAirbnbs}>
                    <table>
                        ...
                        <tr>
                            <td>
                                <input type= "text" name= 'houseType' placeholder='House Type' required />
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type= "url" name= 'image' placeholder='House Image' />
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <input type= "text" name= 'description' placeholder='Cancellation charges'  />
                            </td>
                        </tr>
                        <tr>
                            <td>
